...
<html lang="en">
  <head>
    ...
    <!-- Styles -->
    <link href="http://localhost/Nouveau%20dossier/assets/css/core.min.css" rel="stylesheet">
    <link href="http://localhost/Nouveau%20dossier/assets/css/app.min.css" rel="stylesheet">
    <link href="http://localhost/Nouveau%20dossier/assets/css/style.min.css" rel="stylesheet">

    <!-- Favicons -->
    <link rel="apple-touch-icon" href="http://localhost/Nouveau%20dossier/assets/img/apple-touch-icon.png">
